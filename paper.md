...
open, reproducible research workflows: scientists re-analyzing published
...
reproducible, and the sources of the data \[@Fritz2009, @Jones2009\] are
clear because their DOIs are embedded within the code:
